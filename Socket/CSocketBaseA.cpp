...
char CSocketBase::m_pcHostIP[SOB_IP_LENGTH] = { 0 };
USHORT CSocketBase::m_sHostPort = 0;
...
// CSocketBase 清空本地IP(ASCII)
void CSocketBase::clearHostIP()
{
	memset(m_pcHostIP, 0, SOB_IP_LENGTH);
}

// CSocketBase 清空本地端口
void CSocketBase::clearHostPort()
{
	m_sHostPort = 0;
}
